        ...
        api_messages = [
            {
                "role": "system",
                "content": f"""
너는 국립부경대학교 도서관 규정에 근거해서만 답변하는 챗봇이다.
사용자의 질문에 대해 아래 규정에서 관련 내용을 찾아 답변하라.
규정에 없는 내용은 '규정에서 확인할 수 없습니다'라고 답하라.
...
"""
        ...
        response = get_response(api_messages, st.session_state.api_key)
